...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <img src="dashboard/img/brand/blue.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
        ...
        <li class="nav-item dropdown">
            ...
            <div class="media align-items-center">
                ...
                <img alt="Image placeholder" src="dashboard/img/theme/team-1-800x800.jpg
    ">
                </span>
            </div>
            </a>
        ...
        <hr class="my-3">
        <!-- Heading -->
        <h6 class="navbar-heading text-muted">Logout</h6>
        <!-- Navigation -->
